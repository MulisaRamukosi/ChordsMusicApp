...
public interface TrackDao {
    ...
    @Query("select Track.id, Track.title, Track.track_number, Track.location, Track.artist_id, Track.album_id, Artist.name, " +
    ...
    @Query("select Track.id, Track.title, Track.track_number, Track.location, Track.artist_id, Track.album_id, Artist.name, " +
            "Album.cover_url, Artist.picture_url from Track inner join Artist on Track.artist_id = Artist.id " +
            "inner join Album on Track.album_id = Album.id where Track.album_id = :id order by Track.track_number asc")
